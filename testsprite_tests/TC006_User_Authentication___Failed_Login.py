...
async def run_test():
    ...
    try:
        ...
        # -> Input invalid username and password, then click the login button to test invalid login.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Invalid username or password. Please enter a correct username and password. Note that both fields may be case-sensitive.').first).to_be_visible(timeout=30000)
