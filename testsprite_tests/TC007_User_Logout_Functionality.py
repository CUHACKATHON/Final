...
async def run_test():
    ...
    try:
        ...
        # -> Click the Logout link to initiate logout.
        frame = context.pages[-1]
        # Click the Logout link to initiate logout and test redirection.
        elem = frame.locator('xpath=html/body/nav/div/div/a[6]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Attempt to access the dashboard page to verify that the session has ended and user is redirected to login page.
