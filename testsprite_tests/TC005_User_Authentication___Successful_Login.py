...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to '/login/' page to test counselor login.
        await page.goto('http://localhost:8000/login/', timeout=10000)
        await asyncio.sleep(3)
        

        # -> Click the Logout (admin) link to log out the admin user.
        frame = context.pages[-1]
        # Click the Logout (admin) link to log out the admin user.
        ...
        # -> Click the Login link to navigate to the login page for counselor login test.
        frame = context.pages[-1]
        # Click the Login link to navigate to the login page for counselor login test.
        elem = frame.locator('xpath=html/body/nav/div/div/a[6]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        # -> Input counselor username and password, then submit the login form.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        # Click the Login button to submit the counselor login form
        elem = frame.locator('xpath=html/body/div/form/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Log out counselor user to prepare for regular user login test.
        frame = context.pages[-1]
        # Click the Logout (counselor1) link to log out the counselor user.
        elem = frame.locator('xpath=html/body/nav/div/div/a[7]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Click the Login link to navigate to the login page for regular user login test.
        frame = context.pages[-1]
        # Click the Login link to navigate to the login page for regular user login test.
        elem = frame.locator('xpath=html/body/nav/div/div/a[6]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        # -> Input regular user username and password, then submit the login form.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        # Click the Login button to submit the regular user login form
        elem = frame.locator('xpath=html/body/div/form/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Log out the regular user to complete the test cycle.
        frame = context.pages[-1]
        # Click the Logout (testuser) link to log out the regular user.
        elem = frame.locator('xpath=html/body/nav/div/div/a[6]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        await expect(frame.locator('text=You have been logged out successfully.').first).to_be_visible(timeout=30000)
